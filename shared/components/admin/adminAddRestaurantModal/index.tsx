                ...
                <div className='bg-admin-main flex-col pl-7 pt-3 pb-5 pr-7 lg:pr-14 max-h-screen overflow-y-auto'>
                    ...
                    <div className='flex flex-col lg:flex-row w-full mb-10'>
                        ...
                        <div className='bg-admin-modal-framebg w-full lg:w-2/3 pt-5 pl-5 pr-7 rounded-2xl max-h-[390px] overflow-y-scroll scrollbar'>
                            <div>
                                ...
                                <AdminTextarea p='Cuisine' classNameDiv='mt-6' placeholder="Fast Food , Drink, Ice Cream, Sea Food" />
                                ...
                                <AdminInput
                                    type="number"
                                    p='Delivery Min'
                                    classNameDiv="flex flex-col gap-2 mt-6"
                                    placeholder="11"

                                />
                                <AdminInput
                                    p='Address'
                                    classNameDiv="flex flex-col gap-2 mt-4"
                    ...
                    <div className='flex justify-around  border-t-2   border-t-admin-cancel-btn pt-6  border-admin-main gap-10'>
                        <AdminButton
                            ...
                            text='Cancel'
                        />
                        <AdminButton className='text-white bg-admin-purpl-modal-btn py-3 w-1/2 rounded-2xl font-display hover:bg-admin-modal-upload' text='Create  Restuarant' />
                    </div>
                </div>
            </div>
        </div>
